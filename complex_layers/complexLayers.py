...
from .complexFunctions import complex_relu,complex_leakyrelu, complex_max_pool2d, complex_avg_pool2d
...
class Complexleaky_ReLU(Module):

    def forward(self, input):
        return complex_leakyrelu(input)
